...
namespace App
{
    public class UserRepo 
    {
        ...
        public User GetLastUser()
        {
            try
            {
                return GetUsersAsync().Result.Last();
        ...
        public async Task<IEnumerable<User>> QueryProductsAsync(Func<User, bool> predicate)
        {
            try
            {
                var products = _databaseContext.Users.Where(predicate);
